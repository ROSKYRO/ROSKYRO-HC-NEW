...
class AgentStatus(str, enum.Enum):
    ...
    active = "active"                  # fully verified, can be assigned patients
    suspended = "suspended"
    rejected = "rejected"
...
class Agent(Base):
    ...
    # What ROSKYRO pays THIS officer per day of Patient Concierge Program
    # coverage (see PatientCase.daily_rate / coverage_days_and_billing) — NULL
    # until ROSKYRO sets one, so payout estimates don't silently assume a
