...
export const HOSPITAL_WA_LINK = waLink(
  WHATSAPP_SUPPORT_NUMBER,
  `Hi ${BRAND}, I'd like to speak with the Hospital Partnership Lead.`
);
export const SAFETY_WA_LINK = waLink(
  WHATSAPP_SUPPORT_NUMBER,
  `Hi ${BRAND}, I have a safety concern I need to report urgently.`
);
// Kept only for any legacy dynamic tel: usage (e.g. per-record contact numbers);
// all static support/helpline CTAs now route to WhatsApp via the *_WA_LINK exports above.
