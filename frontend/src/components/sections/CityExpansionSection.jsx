    ...
    <section className="bg-ink text-parchment py-20">
      <div className="max-w-3xl mx-auto px-5 text-center">
        <span className="text-xs font-semibold tracking-wide text-magenta inline-flex items-center gap-1">
          <img src="/brand/logo-sm.png" alt="ROSKYRO" className="w-3.5 h-3.5 object-contain" /> {PILOT_CITY} is just our first Hive
        </span>
        ...
        {status === "sent" && <p className="text-sm text-parchment/70 mt-4">Thanks — we'll factor {finalCity} into where we launch next. <img src="/brand/logo-sm.png" alt="ROSKYRO" className="inline-block w-4 h-4 align-[-3px]" /></p>}
