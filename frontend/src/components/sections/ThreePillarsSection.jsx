              ...
              <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                <div className="lg:col-span-7">
                  ...
                  <div className="space-y-3 mb-8">
                    ...
                    <div className="flex items-start gap-3 p-3 rounded-xl bg-violet/5 border border-violet/10 text-xs text-ink/80">
                      ...
                      <div>
                        <strong className="text-ink">Annual Memberships:</strong> Choose ROSKYRO Care, Family, or NRI Care plans for ongoing doctor consults, ambulance covers, and monthly companion visits.
                      </div>
                    </div>
                  </div>
                ...
                <div className="lg:col-span-5 bg-gradient-to-br from-violet via-purple-900 to-ink text-white rounded-2xl p-6 sm:p-7 shadow-xl">
                  <div className="text-xs font-bold text-flare uppercase tracking-wider mb-2">
                    Annual Family Concierge Pass
                  </div>
                  <h4 className="font-display text-2xl font-bold mb-2">ROSKYRO Care Membership</h4>
                  ...
                  <div className="space-y-2 text-xs text-white/90 mb-6 bg-white/10 p-4 rounded-xl">
                    <div className="flex items-center gap-2">
                      ...
                      <span>Dedicated Family Care Manager</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <CheckCircle2 className="w-3.5 h-3.5 text-flare shrink-0" />
                      <span>4 Doctor Consultations Included</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <CheckCircle2 className="w-3.5 h-3.5 text-flare shrink-0" />
                      <span>2 Hospital Concierge Visits / Month</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <CheckCircle2 className="w-3.5 h-3.5 text-flare shrink-0" />
                      <span>2 Ambulance Dispatches Covered</span>
                    </div>
                  </div>
                  <Link
                    to="/membership/info"
                  ...
                  >
                    View All 3 VIP Membership Plans →
                  </Link>
                </div>
              </div>
            </div>
