  ...
  return (
    <section id="investor" className="bg-ink text-parchment py-20">
      <div className="max-w-3xl mx-auto px-5 text-center">
        <span className="text-xs font-semibold tracking-wide text-magenta inline-flex items-center gap-1"><img src="/brand/logo-sm.png" alt="ROSKYRO" className="w-3.5 h-3.5 object-contain" /> Be part of the journey</span>
