import { BOOK_WA_LINK, SUPPORT_PHONE_DISPLAY } from "../../config";
  ...
  return (
    <section className="max-w-6xl mx-auto px-5 pb-24">
      <div className="bg-brand-gradient rounded-card p-10 text-center text-white">
        ...
        <p className="opacity-90 mb-8">Talk to our team on WhatsApp.</p>
        <div className="flex flex-wrap justify-center gap-3">
          <a href={BOOK_WA_LINK} target="_blank" rel="noreferrer"
            ...
            <img src="/brand/logo-sm.png" alt="ROSKYRO" className="inline-block w-4 h-4 align-[-3px] mr-1" /> Chat on WhatsApp
          </a>
          <a href={BOOK_WA_LINK} target="_blank" rel="noreferrer"
