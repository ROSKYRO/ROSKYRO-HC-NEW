      ...
      <div className="max-w-6xl mx-auto px-5 grid md:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <p className="text-ink/60 max-w-md mb-2">
            Everything you love about ROSKYRO on WhatsApp — now in one simple app. Stay updated on
            your family's care and manage it all in one place.
          </p>
          ...
          <p className="text-xs text-ink/40 mt-4">Until then, just message us on WhatsApp — no download needed.</p>
        </div>
        <div className="flex justify-center">
          <div className="w-48 h-96 bg-ink rounded-[2rem] p-3 relative shadow-xl">
            <div className="w-full h-full bg-parchment rounded-[1.5rem] flex flex-col items-center justify-center gap-3">
              ...
              <img src="/brand/logo-sm.png" alt="ROSKYRO" className="w-14 h-14 object-contain" />
