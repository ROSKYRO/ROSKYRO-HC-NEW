...
const PROMISES = [
  ...
  { icon: "🔑", title: "You control every visit.", desc: "Your Partner's name and photo ID before arrival. Nothing happens without your say-so, and you can reach our team any time during a visit." },
  ...
  { icon: "📋", title: "Everything is on the record.", desc: "Every visit is documented — who came, when, and what was done. If there's ever a dispute, the facts are already written down." },
  ...
  return (
    <section className="bg-ink text-parchment py-20">
      <div className="max-w-6xl mx-auto px-5">
        ...
        <p className="text-parchment/60 mb-10 max-w-2xl">Most services hide this page. We'd rather you read ours before you begin.</p>
