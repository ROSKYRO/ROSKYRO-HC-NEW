  ...
  return (
    <section id="terms" className="max-w-4xl mx-auto px-5 py-20">
      ...
      <p className="text-ink/60 mb-8">
        Short, clear, and fair — these keep both you and our Partners safe. By using a ROSKYRO
