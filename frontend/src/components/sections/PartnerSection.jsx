...
export default function PartnerSection() {
  return (
    <section id="join" className="max-w-6xl mx-auto px-5 py-20">
      ...
      <h2 className="font-display text-3xl text-ink mt-3 mb-4">Join ROSKYRO. Earn with dignity.</h2>
      ...
      <h3 className="font-display text-2xl text-ink mb-6">Why join ROSKYRO as a Relationship Officer?</h3>
      ...
      <div className="grid md:grid-cols-2 gap-10">
        <div>
          <div className="text-sm font-semibold text-ink mb-3">📍 We're currently hiring Relationship Officers in {PILOT_CITY}.</div>
        ...
        <div className="bg-mist rounded-card p-6">
          ...
          >
            <img src="/brand/logo-sm.png" alt="ROSKYRO" className="inline-block w-4 h-4 align-[-3px] mr-1" /> Apply to become a Relationship Officer on WhatsApp
          </a>
